    ...
    const fetchData = async () => {
      try {
        const [usersRes, jobsRes, applicantsRes, hrRes] = await Promise.all([
          axios.get('https://sayc-app-api-39gxh.ondigitalocean.app/api/candidate/'),
          axios.get('https://sayc-app-api-39gxh.ondigitalocean.app/api/candidate/allPosts'),
          axios.get('https://sayc-app-api-39gxh.ondigitalocean.app/api/hr/all_applicants'),
          axios.get('https://sayc-app-api-39gxh.ondigitalocean.app/api/hr/allHRMembers')
        ]);
